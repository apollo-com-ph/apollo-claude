#!/usr/bin/env bash
# apollotech-otel-headers.sh — outputs JSON auth headers for Claude Code's otelHeadersHelper
# Downloaded by setup-apollotech-otel-for-claude.sh. Reads credentials from ~/.claude/apollotech-config.
set -euo pipefail
